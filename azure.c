...
void set_data_device(ContosoAnemometer **myWeather){
    int avgWindSpeed = 10;
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        set_data_device(&myWeather);
                        {
                            unsigned char* destination;
                            size_t destinationSize;
                            if (SERIALIZE(&destination, &destinationSize, myWeather->DeviceId, myWeather->Temperature, myWeather->Humidity) != CODEFIRST_OK)
                            {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (Map_AddOrUpdate(propMap, "level", "critical") != MAP_OK)
                                    {
